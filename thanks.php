...
<body>
	...
	<div class="alfred"><span>ALFRED</span></div>
	</div>
...
<div class="card">
	<img src="pictures/naviii.png" alt="Avatar" style="width: 100%">

	<div class="container">
		
		<h4>Thank you for shopping with <span class=trademark>Navi&Kayla</span> <?php echo "$name";?>.</h4>
		<p>You will receive a message about your orders very soon, feel free to send us a message on our email or whatsapp if you wish to cancel your order.
		After products have been delivered in good condition they will not be accepted as returns.</p>
