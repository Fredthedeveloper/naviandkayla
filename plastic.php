			...
			<div class="row">
				...
				<div class="col-lg-9  order-1 order-lg-2 mb-5 mb-lg-0">
					<div class="row">
							...
							<form method="post" action="plastic.php?action=add&productcode=<?php echo $row["productcode"]; ?>">
							<div class="product-item">
								<div class="pi-pic">
									<img src="Admin/lite version/imgFolder/<?php echo $row['productimage']?>" alt="">
									<div class="pi-links">
				...
				<div class="col-lg-4 col-sm-6">
					<div class="footer-widget about-widget">
						...
						<ul>
							...
							<li><a href=>Send us a Message on Instagram: @Navi&Kayla</a></li>
						</ul>
