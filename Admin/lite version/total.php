            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-6 col-8 align-self-center">
                        <h3 class="text-themecolor m-b-0 m-t-0">Confirm orders/Total page</h3>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)"> Confirm orders/Total</a></li>
                            <li class="breadcrumb-item active">Confirm orders/Total page</li>
                        </ol>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                                        ...
                                        <thead>
                                            <tr>
                                               <th>id</th>
                                                ...
                                                <th>state</th>
                                                <th>Phone number</th>
                                                <th>delivery within lagos</th>
                                                <th>delivery outside lagos</th>
                                                <th>come to the store directly</th>
                                                <th>payment</th>
                                                <th>name</th>
                                                <th>order_email</th>
                                                <th>order_product</th>
                                       ...
                                       <tbody>
                                        <tr>
                                               <td><?php echo $row['id']; ?></td>
                                                <td><?php echo $row['addressa']; ?></td>
                                                <td><?php echo $row['state']; ?></td>
                                                <td><?php echo $row['phonenumber']; ?></td>
                                                <td><?php echo $row['delieverywithinlagos']; ?></td>
                                                <td><?php echo $row['delieveryoutsidelagos']; ?></td>
                                                <td><?php echo $row['storedirectly']; ?></td>
                                            ...
                                            <td><a href="deleteconcart.php?id=<?php echo $row['id'];?>">DELETE</a></td>
                        ...
                        <div class="card">
                            <div class="card-block">
                                <h4 class="card-title">Confirm total</h4>
                                       ...
                                       <tbody>
                                        <tr>
                                           <td><?php echo $row['id']; ?> </td>
                                            ...
                                            <td><a href="deletetotal.php?id=<?php echo $row['id'];?>">DELETE</a></td>
