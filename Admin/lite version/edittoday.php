...
$imgFoldertoday="imgFoldertoday";


if (!file_exists($imgFoldertoday)) {
    mkdir($imgFoldertoday);
}

$temp_file=$_FILES["productimage"]["tmp_name"];

$allowed_format = array("jpg" ,"png", "jpeg","PNG","JPG","JFIF","jfif","webp");
$targetFilePath=($imgFoldertoday . basename($productimage));
...
move_uploaded_file($temp_file, "$imgFoldertoday/$productimage");


$insert_reg="INSERT INTO todayproducts (productname,  productprice, productimage, productcode, productstatus ) VALUES('$productname','$productprice','$productimage' ,'$productcode','$productstatus')";
$run_reg=mysqli_query($conn,$insert_reg);

if ($run_reg) {
        $succMsg="your product has been added to Navi&Kayla";

        header("Location: edittoday.php");
        exit;
    }
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-6 col-8 align-self-center">
                        <h3 class="text-themecolor m-b-0 m-t-0">Edit Today's Deal</h3>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                            <li class="breadcrumb-item active">Edit Today's Deal</li>
                        </ol>
                    </div>
                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-block">
                                <h4 class="card-title">Note from Michael: Today's Deal should always be cheaper than the original price</h4>
                                        ...
                                        <tr>
                                          ...
                                          <td><?php echo $row['productimage']; ?> </td>
                                           <td><?php echo $row['productcode']; ?> </td>
                                            ...
                                            <td><a href="deletetoday.php?id=<?php echo $row['id'];?>">DELETE</a></td>
