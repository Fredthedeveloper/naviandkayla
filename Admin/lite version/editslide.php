...
$imgFolderslide="imgFolderslide";


if (!file_exists($imgFolderslide)) {
    mkdir($imgFolderslide);
}

$temp_file=$_FILES["productimage"]["tmp_name"];

$allowed_format = array("jpg" ,"png", "jpeg","PNG","JPG","JFIF","jfif");
$targetFilePath=($imgFolderslide . basename($productimage));
$file_type=pathinfo($targetFilePath, PATHINFO_EXTENSION);

if (($productname=="") || ($productprice=="") ||  ($productdescription=="") ||  ($productcode=="")  ){
    $errMsg="A field or more is empty,guyyyy";
}
...
move_uploaded_file($temp_file, "$imgFolderslide/$productimage");


$insert_reg="INSERT INTO productslideshow (productname,  productprice, productimage, productdescription,productcode ) VALUES('$productname','$productprice','$productimage' ,'$productdescription','$productcode')";
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-6 col-8 align-self-center">
                        <h3 class="text-themecolor m-b-0 m-t-0">Edit slideshow</h3>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                            <li class="breadcrumb-item active">To err is man to edit is divine -Alfred Michael!</li>
                        </ol>
                    </div>
                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-block">
                                <h4 class="card-title">Add new slideshow for home page and today's deal,only add once to initialize</h4>
            ...
            ?>
                                    ...
                                    <div class="form-row">
                                        ...
                                        <label >Product Price</label>
                                            ...
                                            <textarea type="description" class="form-control" rows="5" placeholder="'product name' is very durable...." name="productdescription"></textarea>

                                             <label >Product code</label>
                                            <textarea type="code" class="form-control"  placeholder="e.g Bucket01" name="productcode"></textarea>
                                ...
                                <div class="table-responsive">
                                    ...
                                    $sql = "SELECT * FROM productslideshow";
                                        ...
                                        <tr>
                                          ...
                                          <td><?php echo $row['productimage']; ?> </td>
                                           <td><?php echo $row['productdescription']; ?> </td>
                                            ...
                                            <td><a href="deleteslide.php?id=<?php echo $row['id'];?>">DELETE</a></td>
