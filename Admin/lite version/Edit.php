...
$targetFilePath=($imgFolder . basename($productimage));
...
move_uploaded_file($temp_file, "$imgFolder/$productimage");


$insert_reg="INSERT INTO products (productname,  productprice, productimage, productcode, productstatus ) VALUES('$productname','$productprice','$productimage' ,'$productcode','$productstatus')";
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-6 col-8 align-self-center">
                        <h3 class="text-themecolor m-b-0 m-t-0">Edit plastic Products</h3>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                            <li class="breadcrumb-item active">Edit plastic Products</li>
                        </ol>
                    </div>
                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-block">
                                <h4 class="card-title">Add new plastic Products</h4>
