...
$imgFoldertopselling="imgFoldertopselling";


if (!file_exists($imgFoldertopselling)) {
    mkdir($imgFoldertopselling);
}

$temp_file=$_FILES["productimage"]["tmp_name"];

$allowed_format = array("jpg" ,"png", "jpeg","PNG","JPG","JFIF","jfif","webp");
$targetFilePath=($imgFoldertopselling . basename($productimage));
...
move_uploaded_file($temp_file, "$imgFoldertopselling/$productimage");


$insert_reg="INSERT INTO  topsellingproducts (productname,  productprice, productimage, productcode, productstatus ) VALUES('$productname','$productprice','$productimage' ,'$productcode','$productstatus')";
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-6 col-8 align-self-center">
                        <h3 class="text-themecolor m-b-0 m-t-0">Edit top selling product</h3>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                            <li class="breadcrumb-item active">Edit top selling on the home page</li>
                        </ol>
                    </div>
            ...
            ?>
                                ...
                                <div class="table-responsive">
                                    ...
                                    $sql = "SELECT * FROM  topsellingproducts";
                                        ...
                                        <tr>
                                          ...
                                          <td><?php echo $row['productimage']; ?> </td>
                                           <td><?php echo $row['productcode']; ?> </td>
                                            ...
                                            <td><a href="deletetopproducts.php?id=<?php echo $row['id'];?>">DELETE</a></td>
