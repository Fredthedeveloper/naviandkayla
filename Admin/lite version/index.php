...
<?php require_once 'functions3.php' ?>
...
if (isset($_POST["submit"])) {
    ...
    if (($reminderdescription==""))
    {
     ...
     else
     {
        ...
        $insert_reg="INSERT INTO reminders (reminder) VALUES('$reminderdescription')";
        $run_reg=mysqli_query($conn,$insert_reg);

        if ($run_reg) {
        $succMsg="Your reminder has been added";
                    ...
                    <div class="col-sm-6">
                        <div class="card">
                            <div class="card-block">
                                <h4 class="card-title">Income so far!</h4>
                                <div class="text-right">
                                    <h2 class="font-light m-b-0"><i class="ti-arrow-up text-success"></i> ₦ <?php echo $row["SUM(CAST(REPLACE(order_total, ',','.') as decimal(29, 10)))"]?></h2>
                                    <span class="text-muted">ALFRED!!</span>
                                </div>
 ...
 <?php  
                ...
                ?>
                    ...
                    <div class="col-sm-6">
                        <div class="card">
                            <div class="card-block">
                                <h4 class="card-title">Welcome Ajenavi</h4>
                                <div class="text-right">
                                    <h2 class="font-light m-b-0"><i class="ti-arrow-up text-info"></i>Navi&Kayla</h2>
                                    <span class="text-muted">What are we adding to the website today</span>
                                </div>
                            ...
                            <div class="card-block">
                                ...
                                <form class="form_admin" method="POST" enctype="multipart/form-data">
                                     ...
                                     <label >Reminder Description.</label>
                                            <textarea type="reminder" class="form-control" rows="5" placeholder="Deliver good's by tuesday!" name="reminderdescription"></textarea>

                                            <button type="submit" class="btn btn-primary" name="submit" onclick="return mess();">Add to Reminders</button>
                                ...
                                <div class="lora-lora">
                                <textarea  type="text" name="" class="form-control" value=""><?php echo $row['reminder']; ?></textarea>
                                 <a href="deletereminder.php?id=<?php echo $row['id'];?>">DELETE</a>
                                </div>
                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-block">
                                ...
                                <h4 class="card-title">Messages From Customers</h4>
                                ...
                                ?>
                                        <tbody>
                                            ...
                                            <tr>
                                                <td><span class="round round-primary">CS</span></td>
                                                <td>
                                                    <h6><?php echo $row['name']; ?></h6><small class="text-muted"><?php echo $row['email']; ?></small>
                                            
                                                </td>
                                                <td><h6><?php echo $row['subject']; ?></h6>
                                                <small class="text-muted"><?php echo $row['message']; ?></small>
                                            </td>
                                            <td> <a href="deletemessage.php?id=<?php echo $row['id'];?>">DELETE</a></td>
