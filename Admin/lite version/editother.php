...
$imgFolderother="imgFolderother";


if (!file_exists($imgFolderother)) {
    mkdir($imgFolderother);
}

$temp_file=$_FILES["productimage"]["tmp_name"];

$allowed_format = array("jpg" ,"png", "jpeg","PNG","JPG","JFIF","jfif","webp" );
$targetFilePath=($imgFolderother . basename($productimage));
...
move_uploaded_file($temp_file, "$imgFolderother/$productimage");


$insert_reg="INSERT INTO otherproducts (productname,  productprice, productimage, productcode, productstatus ) VALUES('$productname','$productprice','$productimage' ,'$productcode','$productstatus')";
$run_reg=mysqli_query($conn,$insert_reg);

if ($run_reg) {
        $succMsg="your product has been added to Navi&Kayla";

        header("Location: editother.php");
        exit;
    }
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-6 col-8 align-self-center">
                        <h3 class="text-themecolor m-b-0 m-t-0">Edit Other Products</h3>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                            <li class="breadcrumb-item active">Edit Other Products(Metals e.t.c)</li>
                        </ol>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-block">
                                 <h4 class="card-title">Add new Products under the other category</h4>
            ...
            ?>
                                    ...
                                    <div class="form-row">
                                        <label >Product Name</label>
                                            <input type="name" class="form-control"  placeholder="e.g Hollandia evap" name="productname">
                                        ...
                                        <label >Product Price</label>
                                            ...
                                            <input type="code" class="form-control"  placeholder="e.g Hollandia01" name="productcode">
                                        ...
                                        <tr>
                                          ...
                                          <td><?php echo $row['productimage']; ?> </td>
                                           <td><?php echo $row['productcode']; ?> </td>
                                            ...
                                            <td><a href="deleteother.php?id=<?php echo $row['id'];?>">DELETE</a></td>
