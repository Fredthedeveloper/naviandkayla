                ...
                <div class="row page-titles">
                    <div class="col-md-6 col-8 align-self-center">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">This is the cart table not orders!</li>
                        </ol>
                    </div>
                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-block">
                                <h4 class="card-title">View cart for reference to orders</h4>
                                       ...
                                       <tbody>
                                        <tr>
                                          ...
                                          <td><?php echo $row['custphonenumber']; ?> </td>
                                           ...
                                           <td><?php echo $row['custproducts']; ?> </td>
                                           ...
                                           <td><?php echo $row['dateposted']; ?> </td>
                                            ...
                                            <td><a href="deletecart.php?id=<?php echo $row['id'];?>">DELETE</a></td>
