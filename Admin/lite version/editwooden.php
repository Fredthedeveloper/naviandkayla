...
$imgFolderwooden="imgFolderwooden";


if (!file_exists($imgFolderwooden)) {
    mkdir($imgFolderwooden);
}

$temp_file=$_FILES["productimage"]["tmp_name"];

$allowed_format = array("jpg" ,"png", "jpeg","PNG","JPG","JFIF","jfif","webp" );
$targetFilePath=($imgFolderwooden . basename($productimage));
...
move_uploaded_file($temp_file, "$imgFolderwooden/$productimage");


$insert_reg="INSERT INTO woodenproducts (productname,  productprice, productimage, productcode, productstatus ) VALUES('$productname','$productprice','$productimage' ,'$productcode','$productstatus')";
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-6 col-8 align-self-center">
                        <h3 class="text-themecolor m-b-0 m-t-0">Edit Wooden Products</h3>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                            <li class="breadcrumb-item active">Edit Wooden Products</li>
                        </ol>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-block">
                                 <h4 class="card-title">Add new wooden Products</h4>
            ...
            ?>
                                    ...
                                    <div class="form-row">
                                        <label >Product Name</label>
                                            <input type="name" class="form-control"  placeholder="e.g mortar" name="productname">
                                        ...
                                        <label >Product Price</label>
                                            ...
                                            <input type="code" class="form-control"  placeholder="e.g mortar01" name="productcode">
                              ...
                              <div class="table-responsive">
                                    ...
                                    $sql = "SELECT * FROM woodenproducts";
                                        ...
                                        <tr>
                                          ...
                                          <td><?php echo $row['productimage']; ?> </td>
                                           <td><?php echo $row['productcode']; ?> </td>
                                            ...
                                            <td><a href="deletewood.php?id=<?php echo $row['id'];?>">DELETE</a></td>
