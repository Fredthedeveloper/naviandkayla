...
//$productlatest=get_latest();
$producttop=get_top();
$productbanner=get_banner();
?>
...
<a href="logout.php">Logout</a>
	...
	<section class="product-filter-section">
		<div class="container">
			...
			<div class="row">
				...
				while ($row=mysqli_fetch_assoc($producttop)) {
				...
				<div class="col-lg-3 col-sm-6">
					...
					<div class="product-item">
						<div class="pi-pic">
							...
							<img src="Admin/lite version/imgFoldertopselling/<?php echo $row['productimage']?>" alt="" >
							<div class="pi-links">
			...
			<div class="text-center pt-5">
				<a href="Plastic.php"><button class="site-btn sb-line sb-dark">VIEW MORE</button></a>
			</div>
		</div>
	</section>
	...
	<!-- Banner section -->
				...
				while ($row=mysqli_fetch_assoc($productbanner)) {
								
				?>
	<section class="banner-section">
		<div class="container">
			<div class="banner set-bg" data-setbg= "Admin/lite version/imgFolderbanner/<?php echo $row['productimage']?>"  style="background-image: url('Admin/lite version/imgFolderbanner/<?php echo $row['productimage']?>');" >
				<div class="tag-new">NEW</div>
				<span>New Products</span>
				<h2>Ice Cream cups</h2>
				<a href="plastic.php" class="site-btn">VIEW NOW</a>
			</div>
		</div>
	</section>
								<?php
