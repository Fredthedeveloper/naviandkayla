...
<a href="logout.php">Logout</a>
	...
	<div class="page-top-info">
		<div class="container">
			<h4>Ceramic Products</h4>
			<div class="site-pagination">
				<a href="index.php">Home</a> /
				<a href="ceramic.php">Shop</a> 
			</div>
		</div>
	</div>
	<!-- Page info end -->
                ...
                <div class="col-lg-9  order-1 order-lg-2 mb-5 mb-lg-0">
					...
					?>
						<div class="col-lg-4 col-sm-6">
							<form method="post" action="ceramic.php?action=add&productcode=<?php echo $row["productcode"]; ?>">
							<div class="product-item">
								<div class="pi-pic">
									
									<img src="Admin/lite version/imgFolderceram/<?php echo $row['productimage']?>" alt="">
									<div class="pi-links">
