					...
					<div class="row">
							...
							while ($row=mysqli_fetch_assoc($products)) {
								...
								<div class="col-lg-4 col-sm-6">
									<form method="post" action="wooden.php?action=add&productcode=<?php echo $row["productcode"]; ?>">
										
							
							<div class="product-item">
								<div class="pi-pic">
									<img src="Admin/lite version/imgFolderwooden/<?php echo $row['productimage']?>" alt="">
									<div class="pi-links">
