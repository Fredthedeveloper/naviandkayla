...
if (isset($_POST["submit"])) {
	...
	$select_reg="SELECT * FROM cust_reg WHERE username='$name'";
...
elseif (!filter_var($email, FILTER_VALIDATE_EMAIL)) {
	...
	$insert_reg="INSERT INTO cust_reg (username, email, phonenumber, address, Password) VALUES('$name','$email','$phonenumber', '$address','$password')";
...
<H2>SIGN UP HERE</H2>
		...
		<input class="form-control" type="text" name="phonenumber" placeholder="Phone Number">
				...
				<label>Address:</label>
		<textarea type="description" class="form-control" rows="5" placeholder="No, 2 John avenue" name="address"></textarea>
